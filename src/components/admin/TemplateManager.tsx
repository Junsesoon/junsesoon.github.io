...
import { addTemplateAction, deleteTemplateAction } from '../../actions/actions';
import { addPropertyAction, deletePropertyAction, getAllPropertiesWithTypesAction, updatePropertyTypeAction } from '../../actions/propertyActions';
