  ...
  return (
    <div className="mx-auto max-w-7xl p-8 font-sans">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <button className="inline-flex items-center justify-center rounded-md bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
          + Create New Post
        </button>
      </div>
